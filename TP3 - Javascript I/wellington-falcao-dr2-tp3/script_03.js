/* Crie um programa que calcule o novo valor de um salário a partir de um valor percentual de reajuste. *
...
// Entrada de dados
let salarioAtual = Number(prompt("Digite o valor do salário").replace(",","."));
porcentagemReajuste =
  Number(prompt("Digite o valor do reajuste em porcentagem").replace("%","")) / 100;
